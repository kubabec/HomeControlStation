...
void HTTPAsyncRequestHandler::createServiceCall()
{
    ...
    case serviceCall_NoParams:
        serviceCallStatus = (std::any_cast<DeviceServicesAPI>(DataContainer::getSignalValue(SIG_DEVICE_SERVICES))).serviceCall_NoParams(currentRequest.requestData[DEVICE_ID_IN_ASYNC_REQUEST_SERVICE_CALL], (DeviceServicesType)currentRequest.requestData[SERVICE_NAME_INDEX]);
        break;
    ...
    case serviceCall_1:
        ...
        serviceCallStatus = (std::any_cast<DeviceServicesAPI>(DataContainer::getSignalValue(SIG_DEVICE_SERVICES))).serviceCall_set1(currentRequest.requestData[DEVICE_ID_IN_ASYNC_REQUEST_SERVICE_CALL], (DeviceServicesType)currentRequest.requestData[SERVICE_NAME_INDEX], set1);
        break;

    case serviceCall_2:
        memcpy(&set2, &currentRequest.requestData[DEVICE_ID_IN_ASYNC_REQUEST_SERVICE_CALL + 1], sizeof(ServiceParameters_set2));
        serviceCallStatus = (std::any_cast<DeviceServicesAPI>(DataContainer::getSignalValue(SIG_DEVICE_SERVICES))).serviceCall_set2(currentRequest.requestData[DEVICE_ID_IN_ASYNC_REQUEST_SERVICE_CALL], (DeviceServicesType)currentRequest.requestData[SERVICE_NAME_INDEX], set2);
        break;
    ...
    case serviceCall_3:
        ...
        serviceCallStatus = (std::any_cast<DeviceServicesAPI>(DataContainer::getSignalValue(SIG_DEVICE_SERVICES))).serviceCall_set3(currentRequest.requestData[DEVICE_ID_IN_ASYNC_REQUEST_SERVICE_CALL], (DeviceServicesType)currentRequest.requestData[SERVICE_NAME_INDEX], set3);
...
void HTTPAsyncRequestHandler::createNotificationCountJson()
{
    ...
    jsonResponse += "{";
    jsonResponse += "\"ntcnt\":" + String((int)count);
    jsonResponse += "}";
}
...
{
    String deviceCfg = std::any_cast<DeviceConfigManipulationAPI>(DataContainer::getSignalValue(SIG_SET_CONFIG_VIA_JSON_STRING)).getDeviceCfgJson();

    String localSetup = std::any_cast<DeviceConfigManipulationAPI>(DataContainer::getSignalValue(SIG_SET_DEVICES_CONFIG_VIA_JSON)).getDeviceCfgJson();

    String roomsCfg = std::any_cast<DeviceConfigManipulationAPI>(DataContainer::getSignalValue(CBK_GET_ROOMS_CFG_JSON)).getDeviceCfgJson();
